...
GOTCUBE = "Tajemniczy artefakt przemawia do ciebie... \"We are many. We are one. We are the Praeleanthor. You know us as the \crSoul Cube\c-.\" \cf(\cjSlot 8\cf)";
...
GOTCRYSTAL = "Otrzymał@[irreg_3_pl]ś Cookie-Crystal! \c[brick]Cookiedemon\c- is ready... \cf(\cjThis item must be activated to use it\cf)";
