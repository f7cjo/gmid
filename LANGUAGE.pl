...
STARTUP3 = "\n";
STARTUP4 = "OSTRZEŻENIE: Absurdalna ilość głupoty przed wami!";
STSTR_DQDON	= "Co jest, granie według zasad jest dla ciebie zbyt trudne?";
STSTR_DQDOFF = "To mi się bardziej podoba.";
STSTR_NCON	= "Układy map są trudne w nawigacji!";
STSTR_NCOFF	= "Wygląda na to, że nie aż tak trudne...";
STSTR_NC2ON = "Równie dobrze mógłbyś być w tym momencie niewidzialny.";
TXT_BUDDHAON = "Zmieniłeś swoje przekonania religijne!";
TXT_BUDDHAOFF = "Wróciłeś do swoich starych przekonań.";
STSTR_KFAADDED	= "Jak można mieć przy sobie tyle rzeczy?";
STSTR_FAADDED = "Masz teraz cały asortyment broni... ty oszuście.";
STSTR_CHOPPERS = "Po co w ogóle zawracać sobie głowę, skoro ten kod jest zepsuty?";
MSGOFF = "Przyszłe wiadomości będą teraz ukryte.";
MSGON = "Przyszłe wiadomości będą teraz wyświetlane.";
NETEND = "Nie możesz jeszcze zakończyć gry sieciowej!\n\n"
		 "Naciśnij dowolny klawisz, aby kontynuować.";
ENDGAME = "Czy na pewno chcesz zakończyć tą grę?\n\n"
		  "Naciśnij Y lub N, aby potwierdzić.";
GGSAVED = "Twoja gra została pomyślnie zapisana.";
HUSTR_MSGU = "Nie udało się wysłać twoją wiadomość!";
...
TXT_FRAGLIMIT = "Limit fragów osiągnięty! Zobaczmy wyniki!";
TXT_TIMELIMIT = "Limit czasu osiągnięty! Zobaczmy wyniki!";

SECRETMESSAGE = "Odkryto sekretny obszar!";

STSTR_CLEV = "Poziom jest zmieniany...\n";

//Pickup messages
GOTCOLA1 = "Wypito puszkę Caco-Coli. \cf(\cj+2 zdrowia\cf)";
GOTCOLA2 = "Wypito puszkę Caco-Coli Zero. \cf(\cj+5 zdrowia\cf)";
GOTAPPLE = "Zjedzono jabłko. \cf(\cj10 zdrowia\cf)";
GOTGRAPES = "Zjedzono kiść winogron. \cf(\cj10 zdrowia\cf)";
GOTORANGE = "Zjedzono pomarańczę. \cf(\cj10 zdrowia\cf)";
GOTHAMBURG = "Zjedzono hamburgera. \cf(\cj25 zdrowia\cf)";
GOTHAMBURG2 = "Znaleziono hamburgera!";
GOTCHICKEN = "Zjedzono całego kurczaka. \cf(\cj25 zdrowia\cf)";
GOTCHICKEN2 = "Znaleziono całego kurczaka!";
GOTPIZZA = "Objedzono się całą pizzą. \cf(\cj25 zdrowia\cf)";
GOTPIZZA2 = "Znaleziono całą pizzę!";
GOTSOUL = "\c[blue]SoulSphere!";
GOTBOTTLE = "Podniesiono butelkę Caco-Coli! \cf(\cjTen przedmiot musi być aktywowany, aby go użyć\cf)";
GOTSHARD1 = "Nalepiono odłamek pancerza. \cf(\cj+5 pancerza\cf)";
GOTSHARD2 = "Nalepiono super odłamek pancerza. \cf(\cj+10 pancerza\cf)";
GOTENERGY1 = "Odczuwasz mały przypływ ochrony i mocy. \cf(\cj+5 pancerza\cf)";
GOTENERGY2 = "Odczuwasz duży przypływ ochrony i mocy! \cf(\cj+10 pancerza\cf)";
GOTVEST1 = "Nosisz teraz lekki pancerz. \cf(\cj100 pancerza, 25% ochrony\cf)";
GOTVEST2 = "Nosisz teraz silny pancerz. \cf(\cj150 pancerza, 50% ochrony\cf)";
GOTVEST3 = "Nosisz teraz ciężki pancerz. \cf(\cj200 pancerza, 75% ochrony\cf)";
GOTVEST4 = "Jesteś teraz chroniony przez pancerz Praetora! \cf(\cj250 pancerza, 95% ochrony\cf)";
GOTMEGA = "\c[Tan]MegaSfera!";
GOT9MM1 = "Podniesiono magazynek do pistoletu. \cf(\cjAmunicja dla slotu 2\cf)";
GOT9MM2 = "Podniesiono pudełko naboi do pistoletu. \cf(\cjAmunicja dla slotu 2\cf)";
GOTBULLET1 = "Podniesiono łańcuch naboi. \cf(\cjAmunicja dla slotu 4\cf)";
GOTBULLET2 = "Podniesiono pudełko łańcuchów naboi. \cf(\cjAmunicja dla slotu 4\cf)";
GOTSHELLS1 = "Podniesiono garść łusek do strzelby. \cf(\cjAmunicja dla slotu 3\cf)";
GOTSHELLS2 = "Podniesiono skrzynkę łusek do strzelby. \cf(\cjAmunicja dla slotu 3\cf)";
GOTFIRESHELLS1 = "Podniesiono garść łusek \"Dragon's Breath\"! \cf(\cjAmunicja dla Firestick\cf)";
GOTFIRESHELLS2 = "Podniesiono skrzynkę łusek \"Dragon's Breath\"! \cf(\cjAmunicja dla Firestick\cf)";
GOTMISSILE1 = "Podniesiono rakietę. \cf(\cjAmunicja dla slotu 5\cf)";
GOTMISSILE2 = "Podniesiono skrzynkę pełną rakiet. \cf(\cjAmunicja dla slotu 5\cf)";
GOTCHARGE1 = "Podniesiono mniejszy ładunek plazmy. \cf(\cjAmunicja dla slotu 6\cf)";
GOTCHARGE2 = "Podniesiono większy ładunek plazmy. \cf(\cjAmunicja dla slotu 6\cf)";
GOTMANA1 = "Podniesiono fiolkę many. \cf(\cjAmunicja dla slotu 7\cf)";
GOTMANA2 = "Podniesiono słoik many. \cf(\cjAmunicja dla slotu 7\cf)";
GOTCUBEAMMO = "\crKostka Duszy\c- żywi się zebraną przez ciebie duszą wroga.";
GOTBACKPACK2 = "Podniesiono skórzany plecak pełen różnych fajnych rzeczy!";
GOTGRINDER = "Otrzymał@[irreg_3_pl]ś kątówkę! \cf(\cjSlot 1\cf)";
GOTBERETTA = "Otrzymał@[irreg_3_pl]ś Berettę. \cf(\cjSlot 2\cf)";
GOTBERETTA2 = "Otrzymał@[irreg_3_pl]ś drugą Berettę! \cf(\cjSlot 2\cf)";
GOTBOOMSTICK = "Otrzymał@[irreg_3_pl]ś Strzelbę Powtarzalną UAC! \cf(\cjSlot 3\cf)";
GOTFIRESTICK = "Otrzymał@[irreg_3_pl]ś SPAS-12 \"Firestick\"! \cf(\cjSlot 3\cf)";
GOTSAWNOFF = "Otrzymał@[irreg_3_pl]ś Obrzyn! \cf(\cjSlot 3\cf)";
GOTVGUN = "Otrzymał@[irreg_3_pl]ś V-Gun! \cf(\cjSlot 4\cf)";
GOTREVX = "Otrzymał@[irreg_3_pl]ś Karabin ładowany baterią \"Rev-X\"! Rewolucja się rozpoczęła! \cf(\cjSlot 4\cf)";
GOTUPGRADE1 = "Otrzymał@[irreg_3_pl]ś ulepszenie do \"Rev-X\" \"Szybkostrzelne Chłodziwo\"!\n\c[white](Rev-X został ulepszony! Przyspieszono ładowanie baterii!)";
GOTUPGRADE2 = "Otrzymał@[irreg_3_pl]ś ulepszenie do \"Rev-X\" \"Energizer impulsów plazmy!\"!\n\c[white](Rev-X został ulepszony! Zwiększono obrażenia!)";
GOTLAUNCHER = "Otrzymał@[irreg_3_pl]ś Wyrzutnię Rakiet! \cf(\cjSlot 5\cf)";
GOTPINEAPPLE = "Otrzymał@[irreg_3_pl]ś Granatnik \"Pineapple Jammer\"! \cf(\cjSlot 5\cf)";
GOTRAIL = "Otrzymał@[irreg_3_pl]ś Railgun! \cf(\cjSlot 6\cf)";
GOTEXCESS = "Otrzymał@[irreg_3_pl]ś Działko Plazmowe \"Excessive Force\"! \cf(\cjSlot 6\cf)";
GOTPINBALL = "Otrzymał@[irreg_3_pl]ś Zaklęcie Pinball \"Space Cadet\"! Czas, by sprowadzić na nich ból i nostalgię... \cf(\cjSlot 7\cf)";
GOTCUBE = "Tajemniczy artefakt przemawia do ciebie... \"Jest nas wielu. Jest nas jeden. Jesteśmy Praeleantorem.  Znasz nas jako \crKostkę Dusz\c-.\" \cf(\cjSlot 8\cf)";
GOTCUBE2 = "Odzyskałeś \crKostkę Dusz\c-.";
GOTAUTOMAP = "Automapa pobrana!";
GOTBIOSUIT = "Nałożono bio-kombinezon.";
GOTGOGGLES = "Gogle noktowizyjne!";
GOTINVUL = "\c[DarkGreen]Nietykalność!";
GOTDOUBLE = "\cgPodwójne Obrażenia!\c-";
GOTQUAD = "\c[LightBlue]Poczwórne Obrażenia!\c-";
GOTHASTE = "\cxHasteSphere!";
GOTCRYSTAL = "Otrzymał@[irreg_3_pl]ś Cookie-Crystal! \c[brick]Cookiedemon\c- jest gotowa... \cf(\cjTen przedmiot musi być aktywowany, aby go użyć\cf)";
GOTSHAKE = "Wypił@[irreg_3_pl]ś Zaje-Fajny(tm) Szejk Energetyczny! Orzeźwiający! \cf(\cj+50 zdrowia\cf)";

TAG_COLA1 = "Caco-Cola";
TAG_COLA2 = "Caco-Cola Zero";
TAG_APPLE = "Jabłko";
TAG_GRAPES = "Winogrona";
TAG_ORANGE = "Pomarańcz";
TAG_HAMBURG = "Hamburger";
TAG_CHICKEN = "Kurczak";
TAG_PIZZA = "Pizza";
TAG_SOUL = "Soulsphere";
TAG_BOTTLE = "Butelka Caco-Coli";
TAG_SHARD1 = "Odłamek Pancerza";
TAG_SHARD2 = "Super Odłamek Pancerza";
TAG_ENERGY1 = "Mnejsza Energia";
TAG_ENERGY2 = "Większa Energia";
TAG_VEST1 = "Lekki Pancerz";
TAG_VEST2 = "Silny Pancerz";
TAG_VEST3 = "Ciężki Pancerz";
TAG_VEST4 = "Pancerz Praetora";
TAG_MEGA = "Megasphere";
TAG_9MM1 = "Magazynek do pistoletu";
TAG_9MM2 = "Pudełko naboi do pistoletu";
TAG_BULLET1 = "Łańcuch naboi";
TAG_BULLET2 = "Pudełko łancuchów naboi";
TAG_SHELLS1 = "Garść łusek do strzelby";
TAG_SHELLS2 = "Skrzynka łusek do strzelby";
TAG_FIRESHELLS1 = "Garść łusek Dragon's Breath";
TAG_FIRESHELLS2 = "Skrzynka łusek Dragon's Breath";
TAG_MISSILE1 = "Rakieta";
TAG_MISSILE2 = "Skrzynia rakiet";
TAG_CHARGE1 = "Mniejszy Ładunek Plazmy";
TAG_CHARGE2 = "Większy Ladunek Plazmy";
TAG_MANA1 = "Fiołka many";
TAG_MANA2 = "Słoik many";
TAG_CUBEAMMO = "Dusza";
TAG_REVXAMMO = "Bateria Rev-X"; //For compatibility with m8f's Status Widget
TAG_BACKPACK = "Plecak";
TAG_AUTOMAP = "Automapa";
TAG_BIOSUIT = "Bio-Kombinezon";
TAG_GOGGLES = "Gogle noktowizyjne";
TAG_INVUL = "Nietykalność";
TAG_DOUBLE = "Podwójne Obrażenia";
TAG_QUAD = "Poczwórne Obrażenia";
TAG_HASTE = "HasteSphere";
TAG_CRYSTAL = "Cookie-Crystal";
TAG_UPGRADE1 = "Szybkostrzelne Chłodziwo";
TAG_UPGRADE2 = "Energizer impulsów plazmy";
TAG_SHAKE = "Zaje-Fajny(tm) Szejk Energetyczny";

TAG_GRINDER = "Kątówka";
TAG_FISTS = "Gołe Ręce";
TAG_BERETTA = "Beretta";
TAG_BERETTA2 = "Podwójne Beretty";
TAG_BOOMSTICK = "Strzelba Powtarzalna UAC";
TAG_FIRESTICK = "Firestick";
TAG_SAWNOFF = "Obrzyn";
TAG_VGUN = "V-Gun";
TAG_REVX = "Rev-X";
TAG_LAUNCHER = "Wyrzutnia Rakiet";
...
//Obituaries
OB_FISTS = "%o przegrał@[ao_pl] walkę na pięści z %k.";
OB_GRINDER = "%o został@[ao_pl] zkoszon@[adj_pl] przez kątówkę %k.";
OB_BERETTA = "%o nie wymin@[irreg_3_pl] Berrety %k.";
OB_BERETTA2 = "%o był wolniejsz@[adj_pl] od podwójnych Berret %k.";
OB_BOOMSTICK = "%o został@[ao_pl] nafaszerowan@[adj_pl] ołowiem %k.";
...
OB_RAIL = "%o was split by %l's Railgun.";
...
OB_ZSEC2 = "%o was set ablaze by a ZSec Soldier.";
...
QUITMSG5 = "No to idź klikać w te swoje ikony.\n\n"
		   "Będę czekał."; //Mac OS Classic port of Doom
QUITMSG6 = "Pressing Y will install a Peter Griffin-themed virus onto your device.\n"
		   "Do you really want to do this?";
QUITMSG7 = "Jak cię złapię na ładowaniu tego tech demo pk3, to ci przy."; //A certain Doom mod beginning with the letter "H"
...
QUITMSG23 = "Jasne, wróć do przeglądania tego folderu z \"Pracą domową\"...";
...
GOTBLUECARD = "You've found the \chblue\c- keycard!";
GOTYELWCARD = "You've found the \ckyellow\c- keycard!";
GOTREDCARD = "You've found the \cgred\c- keycard!";
...
CUBENOPE = "You don't have enough souls to use the \crSoul Cube\c-!";
...
HIDDENNOTE2 = "but are now available here for your convenience.";
FOVOPTION1 = "FOV";
FOVOPTION2 = "Adjusts your FOV, or \"field of view\", which is how much of the";
FOVOPTION3 = "environment is viewable to you. Default value is 90.";
FOVOPTION4 = "(Console command: \ckfov \cnvalue\c-)";
FPSOPTION1 = "FPS Counter";
FPSOPTION2 = "Displays a simple FPS counter in the top right corner of your screen.";
FPSOPTION3 = "\"ms\" is your input delay, \"fps\" is your framerate.";
FPSOPTION4 = "(Console command: \ckvid_fps \cntrue/false\c-)";
